...
//            implementation(libs.androidx.material3.android)
            ...
            implementation("co.stone.posmobile.sdk:sdk-core:6.0.0-alpha33-dev-001null")
            implementation("co.stone.posmobile.sdk.manufacturer:manufacturer-serial:6.0.0-alpha24-dev-001null")
