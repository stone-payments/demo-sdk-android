...
//            implementation(libs.androidx.material3.android)
            ...
            implementation("co.stone.pos.mobile.sdk:sdk-core:6.0.0-alpha19-dev-036")
            implementation("co.stone.pos.mobile.sdk.manufacturer:manufacturer-serial:6.0.0-alpha19-dev-031")
